...
describe('Recipe model', () => {
  ...
  describe('Validators', () => {
    ...
    // describe('analyzedInstructions value', () => {
    //   it('should throw an error if analyzedInstructions is not a JSON', (done) => {
    //     Recipe.create({title: 'Milanesa a la napolitana', summary:'Bife de carne cubierto con pan rallado'})
    //       .then(() => done(new Error('analyzedInstructions must be a JSON')))
    //       .catch(() => done());
    //   });
    //   it('should work when analyzedInstructions is a JSON', () => {
    //     Recipe.create({title: 'Milanesa a la napolitana', summary:'Bife de carne cubierto con pan rallado', analyzedInstructions: ['step 1'] });
    //   });
    // });
